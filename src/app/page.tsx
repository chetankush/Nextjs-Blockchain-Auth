      ...
      <header className="relative w-full border-b bg-white pb-4 mt-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="lg:hidden">
            <div onClick={toggleMenu} className="h-6 w-6 cursor-pointer" ></div>
          </div>
          {isMenuOpen && (
                ...
                <div className="px-5 pb-6 pt-5">
                  <div className="flex items-center justify-between">
                    <div className="inline-flex items-center space-x-2">
                      ...
                      <span className="font-bold">Small Eth</span>
                    </div>
                    <div className="-mr-2">
                      <button
                        type="button"
        ...
        <div className="mt-12 grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
              <div className="h-9 w-9 text-gray-700" >xyz</div>
            </div>
          ...
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
            <div className="h-9 w-9 text-gray-700" >zap</div>
            </div>
          ...
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
            <div className="h-9 w-9 text-gray-700" >moon</div>
            </div>
          ...
          <div className="-m-6 flex flex-wrap">
            <div className="w-full p-6 md:w-1/2 lg:w-5/12">
              <div className="flex h-full flex-col justify-between">
                ...
                <div>
                  <p className="mb-4  text-base font-medium">Eth solutions is agency that solves software problems using eth</p>
